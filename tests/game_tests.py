...
class GameTests(APITestCase):
    ...
    def test_create_game(self):
        ...
        data = {
            "name": "Clue",
            "description": "A game for the best of the peoples",
            "game_type": 2,
            "min_player": 2,
            "max_player": 10,
            "gamer": 1
        ...
        self.assertEqual(json_response["description"], "A game for the best of the peoples")
        self.assertEqual(json_response["min_player"], 2)
        self.assertEqual(json_response["max_player"], 10)
    ...
    def test_get_game(self):
        ...
        self.assertEqual(json_response["min_player"], 4)
        self.assertEqual(json_response["max_player"], 8)
    ...
    def test_change_game(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(json_response["name"], "Sorryish")
        self.assertEqual(json_response["description"], "Hasbrow")
        self.assertEqual(json_response["min_player"], 6)
        self.assertEqual(json_response["max_player"], 10)
